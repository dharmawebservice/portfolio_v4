...
const PROJECTS = [
  { id:1, num:'01', name:'CraveCart',              type:'Full-Stack Platform',  year:'2025', cat:'fullstack', featured:true,  color:'#FF6B00', live:'https://crave-cart-82wd.onrender.com/', github:'https://github.com/dharmendra1702/Crave_cart', stack:['Django','PostgreSQL','Razorpay','Python'],    desc:'Production food ordering platform with restaurant browsing, Razorpay checkout, coupon logic, live order tracking with courier integration, and Brevo transactional email.' },
  { id:2, num:'02', name:'ATM Simulator & Bank Management System', type:'Desktop Application · Java', year:'2025', cat:'desktop', featured:false, color:'#FF6B00', live:null, github:'https://github.com/dharmendra1702/ATM-Simulator-and-Bank-Management-System', stack:['Java','Swing','JDBC','MySQL'], desc:'Designed and developed an ATM Simulator and Bank Management System using Java Swing and JDBC with MySQL integration. Implemented account management, deposits, withdrawals, balance inquiry, mini-statements, and fast cash features to streamline banking operations.'},
  { id:3, num:'03', name:'Object Detection System', type:'AI/ML + IoT',          year:'2025', cat:'ai',        featured:true,  color:'#22c55e', live:null, github:'https://github.com/dharmendra1702/Object-Detection', stack:['Python','YOLOv3','Raspberry Pi','OpenCV'],   desc:'YOLOv3 real-time object detection on Raspberry Pi with voice feedback, ultrasonic obstacle avoidance sensors, and Blynk IoT remote monitoring dashboard.' },
  { id:4, num:'04', name:'AI Recipe Generator',    type:'Generative AI',        year:'2024', cat:'ai',        featured:false, color:'#3b82f6', live:null, github:'https://github.com/dharmendra1702/Smart-Chef', stack:['OpenAI API','Streamlit','Python'],           desc:'Personalized recipe recommendations from user inputs via OpenAI API. Interactive Streamlit UI with real-time dynamic generation and dietary filter support.' },
  { id:5, num:'05', name:'Online Flight Booking Management System', type:'Web Application', year:'2024', cat:'fullstack', featured:false, color:'#a78bfa', live:null, github:'https://github.com/dharmendra1702/flight-booking-system', stack:['PHP','SQL','HTML','CSS','JavaScript'], desc:'Developed a responsive flight booking and reservation management system with secure user authentication, flight search, booking workflows, and SQL-based backend storage. Designed an intuitive interface to enhance user experience and booking efficiency.' }
];
